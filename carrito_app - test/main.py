...
from baseclasses.reportes2 import *
from baseclasses.ventas2 import *
from baseclasses.compras2 import *
...
Builder.load_file('kvs2/main.kv')
Builder.load_file('kvs2/compras.kv')
Builder.load_file('kvs2/ventas.kv')
Builder.load_file('kvs2/reportes.kv')
